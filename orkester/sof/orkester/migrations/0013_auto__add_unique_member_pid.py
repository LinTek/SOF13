...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Member', fields ['pid']
        db.create_unique('orkester_member', ['pid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Member', fields ['pid']
        db.delete_unique('orkester_member', ['pid'])
