...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.pid'
        db.add_column('orkester_member', 'pid',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=20),
                      keep_default=False)

        # Adding field 'Member.email'
        db.add_column('orkester_member', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.pid'
        db.delete_column('orkester_member', 'pid')

        # Deleting field 'Member.email'
        db.delete_column('orkester_member', 'email')
