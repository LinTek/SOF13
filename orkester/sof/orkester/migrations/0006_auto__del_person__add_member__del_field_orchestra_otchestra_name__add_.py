...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Member'
        db.create_table('orkester_member', (
            ...
            ('orchestra', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orkester.Orchestra'])),
        ))
        db.send_create_signal('orkester', ['Member'])

        # Deleting field 'Orchestra.otchestra_name'
        db.delete_column('orkester_orchestra', 'otchestra_name')

        # Adding field 'Orchestra.orchestra_name'
        db.add_column('orkester_orchestra', 'orchestra_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Orchestra.token'
        db.add_column('orkester_orchestra', 'token',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('orkester_member')


        # User chose to not deal with backwards NULL issues for 'Orchestra.otchestra_name'
        raise RuntimeError("Cannot reverse this migration. 'Orchestra.otchestra_name' and its values cannot be restored.")
        # Deleting field 'Orchestra.orchestra_name'
        db.delete_column('orkester_orchestra', 'orchestra_name')

        # Deleting field 'Orchestra.token'
        db.delete_column('orkester_orchestra', 'token')
    ...
    models = {
        ...
        'orkester.orchestra': {
            ...
            'play_length': ('django.db.models.fields.CharField', [], {'max_length': '5', 'blank': 'True'}),
