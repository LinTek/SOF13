...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Orchestra.name'
        db.delete_column('orkester_orchestra', 'name')

        # Adding field 'Orchestra.ballet_name'
        db.add_column('orkester_orchestra', 'ballet_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Orchestra.name'
        db.add_column('orkester_orchestra', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Deleting field 'Orchestra.ballet_name'
        db.delete_column('orkester_orchestra', 'ballet_name')
