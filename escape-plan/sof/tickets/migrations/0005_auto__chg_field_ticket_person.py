...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.person'
        db.alter_column(u'tickets_ticket', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['functionary.Person']))

    def backwards(self, orm):

        # Changing field 'Ticket.person'
        db.alter_column(u'tickets_ticket', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['functionary.Person'], null=True))
