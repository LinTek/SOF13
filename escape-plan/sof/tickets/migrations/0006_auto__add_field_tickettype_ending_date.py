...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketType.ending_date'
        db.add_column(u'tickets_tickettype', 'ending_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 15, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TicketType.ending_date'
        db.delete_column(u'tickets_tickettype', 'ending_date')
