...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.person'
        db.add_column(u'tickets_ticket', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['functionary.Person'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.person'
        db.delete_column(u'tickets_ticket', 'person_id')
    ...
    models = {
        ...
        u'tickets.ticket': {
            ...
            'is_sent_as_email': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['functionary.Person']", 'null': 'True'}),
