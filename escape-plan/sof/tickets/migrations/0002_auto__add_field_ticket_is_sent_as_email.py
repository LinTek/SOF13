...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.is_sent_as_email'
        db.add_column(u'tickets_ticket', 'is_sent_as_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.is_sent_as_email'
        db.delete_column(u'tickets_ticket', 'is_sent_as_email')
