...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.nice_reminder_sent'
        db.add_column(u'invoices_invoice', 'nice_reminder_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.nice_reminder_sent'
        db.delete_column(u'invoices_invoice', 'nice_reminder_sent')
