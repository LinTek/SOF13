...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.is_card_payment'
        db.add_column(u'invoices_payment', 'is_card_payment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.is_card_payment'
        db.delete_column(u'invoices_payment', 'is_card_payment')
    ...
    models = {
        ...
        u'invoices.payment': {
            ...
            'is_card_payment': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
