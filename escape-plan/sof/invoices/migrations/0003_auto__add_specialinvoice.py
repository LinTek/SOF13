...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SpecialInvoice'
        db.create_table(u'invoices_specialinvoice', (
        ...
        db.send_create_signal(u'invoices', ['SpecialInvoice'])


    def backwards(self, orm):
        # Deleting model 'SpecialInvoice'
        db.delete_table(u'invoices_specialinvoice')
