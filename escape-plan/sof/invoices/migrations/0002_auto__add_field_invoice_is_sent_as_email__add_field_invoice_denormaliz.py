...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.is_sent_as_email'
        db.add_column(u'invoices_invoice', 'is_sent_as_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Invoice.denormalized_total_price'
        db.add_column(u'invoices_invoice', 'denormalized_total_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.is_sent_as_email'
        db.delete_column(u'invoices_invoice', 'is_sent_as_email')

        # Deleting field 'Invoice.denormalized_total_price'
        db.delete_column(u'invoices_invoice', 'denormalized_total_price')
