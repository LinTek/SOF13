...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.fetched_merchandise'
        db.add_column(u'functionary_worker', 'fetched_merchandise',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Worker.fetched_merchandise'
        db.delete_column(u'functionary_worker', 'fetched_merchandise')
    ...
    models = {
        ...
        u'functionary.worker': {
            ...
            'attended_info_meeting': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'contract_approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'fetched_merchandise': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
