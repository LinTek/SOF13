...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.attended_info_meeting'
        db.add_column(u'functionary_worker', 'attended_info_meeting',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Worker.attended_info_meeting'
        db.delete_column(u'functionary_worker', 'attended_info_meeting')
