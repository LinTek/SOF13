...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkerRegistration.worker'
        db.alter_column(u'functionary_workerregistration', 'worker_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'WorkerRegistration.worker'
        db.alter_column(u'functionary_workerregistration', 'worker_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['functionary.Functionary']))
