...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.has_meta_info'
        db.add_column(u'functionary_worker', 'has_meta_info',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Worker.has_meta_info'
        db.delete_column(u'functionary_worker', 'has_meta_info')
