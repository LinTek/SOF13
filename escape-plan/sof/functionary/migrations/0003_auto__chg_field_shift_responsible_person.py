...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Shift.responsible_person'
        db.alter_column(u'functionary_shift', 'responsible_person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Shift.responsible_person'
        raise RuntimeError("Cannot reverse this migration. 'Shift.responsible_person' and its values cannot be restored.")
