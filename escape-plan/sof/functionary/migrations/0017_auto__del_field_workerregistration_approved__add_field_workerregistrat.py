...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WorkerRegistration.approved'
        db.delete_column(u'functionary_workerregistration', 'approved')

        # Adding field 'WorkerRegistration.checked_in'
        db.add_column(u'functionary_workerregistration', 'checked_in',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WorkerRegistration.checked_out'
        db.add_column(u'functionary_workerregistration', 'checked_out',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WorkerRegistration.approved'
        db.add_column(u'functionary_workerregistration', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'WorkerRegistration.checked_in'
        db.delete_column(u'functionary_workerregistration', 'checked_in')

        # Deleting field 'WorkerRegistration.checked_out'
        db.delete_column(u'functionary_workerregistration', 'checked_out')
    ...
    models = {
        ...
        u'functionary.worker': {
            ...
            'has_meta_info': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'ice_number': ('django.db.models.fields.CharField', [], {'max_length': '60', 'blank': 'True'}),
