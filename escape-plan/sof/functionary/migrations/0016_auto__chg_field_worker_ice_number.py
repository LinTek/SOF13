...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Worker.ice_number'
        db.alter_column(u'functionary_worker', 'ice_number', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'Worker.ice_number'
        db.alter_column(u'functionary_worker', 'ice_number', self.gf('django.db.models.fields.CharField')(max_length=20))
