...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'functionary_workerregistration', (
            ...
            ('worker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['functionary.Functionary'])),
    ...
    models = {
        ...
        u'functionary.workerregistration': {
            ...
            'worker': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['functionary.Functionary']"})
        }
    }
