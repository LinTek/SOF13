...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.super_worker'
        db.add_column(u'functionary_worker', 'super_worker',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Worker.super_worker'
        db.delete_column(u'functionary_worker', 'super_worker')
