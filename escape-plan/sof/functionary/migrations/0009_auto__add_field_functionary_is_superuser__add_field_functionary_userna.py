...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Functionary.username'
        db.add_column(u'functionary_functionary', 'username',
                      self.gf('django.db.models.fields.CharField')(default='Meep', unique=True, max_length=30),
                      keep_default=False)
