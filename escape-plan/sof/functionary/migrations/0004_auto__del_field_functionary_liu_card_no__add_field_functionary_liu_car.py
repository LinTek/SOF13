...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Functionary.liu_card_no'
        db.delete_column(u'functionary_functionary', 'liu_card_no')

        # Adding field 'Functionary.liu_card_number'
        db.add_column(u'functionary_functionary', 'liu_card_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Functionary.liu_card_no'
        db.add_column(u'functionary_functionary', 'liu_card_no',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Deleting field 'Functionary.liu_card_number'
        db.delete_column(u'functionary_functionary', 'liu_card_number')
