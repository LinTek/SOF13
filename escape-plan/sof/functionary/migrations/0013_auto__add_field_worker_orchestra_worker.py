...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.orchestra_worker'
        db.add_column(u'functionary_worker', 'orchestra_worker',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Worker.orchestra_worker'
        db.delete_column(u'functionary_worker', 'orchestra_worker')
