...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShiftSubType'
        db.create_table(u'functionary_shiftsubtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'functionary', ['ShiftSubType'])

        # Adding field 'Shift.shift_sub_type'
        db.add_column(u'functionary_shift', 'shift_sub_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['functionary.ShiftSubType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ShiftSubType'
        db.delete_table(u'functionary_shiftsubtype')

        # Deleting field 'Shift.shift_sub_type'
        db.delete_column(u'functionary_shift', 'shift_sub_type_id')
