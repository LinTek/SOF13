...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.contract_approved'
        db.add_column(u'functionary_worker', 'contract_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Worker.contract_approved'
        db.delete_column(u'functionary_worker', 'contract_approved')
