...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.welcome_email_sent'
        db.add_column(u'functionary_worker', 'welcome_email_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Worker.welcome_email_sent'
        db.delete_column(u'functionary_worker', 'welcome_email_sent')
