...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.orchestra'
        db.add_column('orkester_person', 'orchestra',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['orkester.Orchestra']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.orchestra'
        db.delete_column('orkester_person', 'orchestra_id')
