...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.late_registration'
        db.add_column('orkester_member', 'late_registration',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.late_registration'
        db.delete_column('orkester_member', 'late_registration')
