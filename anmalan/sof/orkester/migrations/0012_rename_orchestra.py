...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field orchestras on 'Member'
        db.create_table('orkester_member_orchestras', (
        ...
        db.create_unique('orkester_member_orchestras', ['member_id', 'orchestra_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field orchestras on 'Member'
        db.delete_table('orkester_member_orchestras')
    ...
    models = {
        'orkester.member': {
            ...
            'pid': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
