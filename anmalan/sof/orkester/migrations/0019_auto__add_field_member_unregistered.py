...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.unregistered'
        db.add_column('orkester_member', 'unregistered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.unregistered'
        db.delete_column('orkester_member', 'unregistered')
    ...
    models = {
        'orkester.member': {
            ...
            'unregistered': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
