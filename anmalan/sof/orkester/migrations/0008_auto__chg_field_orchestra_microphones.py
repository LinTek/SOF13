...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Orchestra.microphones'
        db.alter_column('orkester_orchestra', 'microphones', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Orchestra.microphones'
        raise RuntimeError("Cannot reverse this migration. 'Orchestra.microphones' and its values cannot be restored.")
