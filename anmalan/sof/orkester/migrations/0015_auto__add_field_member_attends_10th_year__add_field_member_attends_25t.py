...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.attends_10th_year'
        db.add_column('orkester_member', 'attends_10th_year',
    ...
    def backwards(self, orm):
        # Deleting field 'Member.attends_10th_year'
        db.delete_column('orkester_member', 'attends_10th_year')
    ...
    models = {
        'orkester.member': {
            ...
            'attends_25th_year': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
