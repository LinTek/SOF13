...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.ticket_handed_out'
        db.add_column('orkester_member', 'ticket_handed_out',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Member.ticket_type'
        db.alter_column('orkester_member', 'ticket_type', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):
        # Deleting field 'Member.ticket_handed_out'
        db.delete_column('orkester_member', 'ticket_handed_out')


        # Changing field 'Member.ticket_type'
        db.alter_column('orkester_member', 'ticket_type', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        'orkester.member': {
            ...
            'attends_10th_year': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'attends_25th_time': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'late_registration': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'ticket_handed_out': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'ticket_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
