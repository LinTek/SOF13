...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Member.attends_25th_year'
        db.delete_column('orkester_member', 'attends_25th_year')

        # Adding field 'Member.attends_25th_time'
        db.add_column('orkester_member', 'attends_25th_time',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Member.attends_25th_year'
        db.add_column('orkester_member', 'attends_25th_year',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Member.attends_25th_time'
        db.delete_column('orkester_member', 'attends_25th_time')
