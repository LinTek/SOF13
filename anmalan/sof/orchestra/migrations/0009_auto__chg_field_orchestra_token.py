...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Orchestra.token'
        db.alter_column('orkester_orchestra', 'token', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'Orchestra.token'
        db.alter_column('orkester_orchestra', 'token', self.gf('django.db.models.fields.CharField')(max_length=32))
